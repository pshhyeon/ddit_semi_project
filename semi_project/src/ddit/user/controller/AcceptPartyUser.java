...
@WebServlet("/acceptPartyUser.do")
public class AcceptPartyUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int res = service.acceptPartyUser(map);
		res = service.autoChangePartyStatus(party_no);
